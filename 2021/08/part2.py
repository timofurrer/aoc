...
for signal_patterns, output_values in data:
    ...
    while patterns:
        ...
        elif len(p) == 5 and has_overlaps(4, 2):  # matching 2
            wire_map[2] = p
        elif len(p) == 5 and has_overlaps(1, 2):  # matching 3
            wire_map[3] = p
        elif len(p) == 5 and has_overlaps(4, 3) and has_overlaps(1, 1):  # matching 5
            wire_map[5] = p
        elif len(p) == 6 and has_overlaps(1, 1):  # matching 6
            wire_map[6] = p
        elif len(p) == 6 and has_overlaps(3, 5):  # matching 9
            wire_map[9] = p
