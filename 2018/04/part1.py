...
sleepiest_guard = max(guards_asleep_durations.items(), key=lambda x: x[1])
sleepiest_minute = Counter(guards_asleep_minutes[sleepiest_guard[0]]).most_common(1)[0][0]
print(int(sleepiest_guard[0]) * int(sleepiest_minute))